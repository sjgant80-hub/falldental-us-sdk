...
**FallDental · sovereign single-file US dental practice OS** — sovereign SDK extracted from `falldental-us/index.html`.

## Install
```bash
npm install @ai-native-solutions/falldental-us-sdk
```

## Use
```js
import * as falldental-us from '@ai-native-solutions/falldental-us-sdk';
```

- Playground: https://sjgant80-hub.github.io/falldental-us-sdk/
- MCP wrapper: [`@ai-native-solutions/falldental-us-mcp`](https://github.com/sjgant80-hub/falldental-us-mcp)
- HTTP API: [`@ai-native-solutions/falldental-us-api`](https://github.com/sjgant80-hub/falldental-us-api)
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=falldental-us-sdk](https://sjgant80-hub.github.io/fallmarket/listing.html?id=falldental-us-sdk)
...
- **Companion SDK** (`npm install @ai-native-solutions/falldental-us-sdk-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add falldental-us-sdk -- npx -y @ai-native-solutions/falldental-us-sdk-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/falldental-us-sdk-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=falldental-us-sdk
- **Live URL**: https://sjgant80-hub.github.io/falldental-us-sdk/
- **Source**: https://github.com/sjgant80-hub/falldental-us-sdk
